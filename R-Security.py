...
# -----------------------------------------------------------
# created By ./Rohan Nahak
# Update 01 Apri 2022 12:00
# Thanks use this service
# R-Security Cyber Security Group
# ---------------------------------------------------------------
...
def logo():
	...
	return '''
%s╭━┳━╭━╭━╮%s╮╲╲╲╲╲╲%sROHAN NAHAK
%s┃┈R┈┣▅╋▅┫┃%s╲╲╲╲╲╲%sWWW.SCNINFOGA.IN
%s┃┈┃┈╰━╰━━━━━━╮%s╲╲%sINSTAGRAM = rohan_nahak.h.r
%s╰┳╯┈┈┈┈┈┈┈┈┈◢▉◣%s╲%s╔═╗╔╦╗╔═╗
%s╲┃┈R-Security-▉%s╲%s╚═╗║║║╚═╗
%s╲┃┈┈5.1┈┈┈┈┈◥▉◤%s╲%sCYBER SECURITY TRAINING
%s╲┃┈┈┈┈╭━┳━━━━╯%s╲╲%s╦ ╦╦ ╦╔═╗╔╦╗╔═╗╔═╗╔═╗╔═╗
%s╲┣━━━━━━┫%s╲╲╲╲╲╲╲%s║║║╠═╣╠═╣ ║ ╚═╗╠═╣╠═╝╠═╝
%s╲┃┈┈┈┈┈┈┃%s╲╲╲╲╲╲╲%s╚╩╝╩ ╩╩ ╩ ╩ ╚═╝╩ ╩╩  ╩  
